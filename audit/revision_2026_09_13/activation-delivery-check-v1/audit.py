...
HERE=BASE/"audit/revision_2026_09_13/activation-delivery-check-v1"
...
def main():
    ...
    for item in inventory:
        ...
        if model not in labels:
            ...
            assert digest(lv)==read_json(lm)["outputs"][str(lv)]
        ...
        for r in rows:
            ...
            assert r["states_sha256"]==meta["outputs"][r["states_path"]]
