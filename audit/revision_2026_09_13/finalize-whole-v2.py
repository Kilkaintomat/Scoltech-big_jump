...
out=audit/"reviews/whole-project-final-v2"
...
for copied in sorted((out/"artifacts").rglob("*")):
    ...
    original=Path("/")/Path(*relative.parts[1:]) if relative.parts[0]=="external" else base/relative
...
snapshot=audit/"finalize-whole-inputs-v2"
current_queues={}
