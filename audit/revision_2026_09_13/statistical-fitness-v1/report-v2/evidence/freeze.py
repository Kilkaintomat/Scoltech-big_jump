...
previous=Path("audit/revision_2026_09_13/snapshots/lean-local-toolchain-v7/source-manifest.json").resolve()
out={}
...
manifest={"inputs":{str(previous):hashlib.sha256(previous.read_bytes()).hexdigest()},"outputs":out,
 "metrics":{**old["metrics"],"created_utc":datetime.datetime.now(datetime.timezone.utc).isoformat(),"amendment":"statistical-fitness-v1","dirty":True}}
