...
for model in ["deepseek","goedel","kimina"]:
    ...
    for sample in selected:
        ...
        comparisons.append({"model":model,"trace_id":rid,
            "serial_parallel_equal":semantic(result[1][rid])==semantic(result[4][rid]),
...
parallel=sum(r["seconds"] for r in measurements if r["workers"]==4)
...
metrics={"measurements":measurements,"serial_seconds":serial,"parallel_seconds":parallel,"speedup":speedup,
 ...
 "settings_unchanged":True,"source_segmentation_fix":False}
