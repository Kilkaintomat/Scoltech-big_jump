...
target = Path("/Users/den/work/Scoltech-big_jump/reports/revision_2026_09_13/local-runtime")
target.mkdir(parents=True,exist_ok=True)
logging.basicConfig(level=logging.INFO,format="%(asctime)s %(message)s")
remote = "/beegfs/home/denis.rakhmankin/onebigjump/audit/revision_2026_09_13/delivery-local"
