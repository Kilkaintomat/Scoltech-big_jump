...
Срез UTC: 2026-09-13T19:25:24.443425Z. Цифры сформированы программой report.py из журналов и Slurm.

Сохранено 20016 ответов. В текущих журналах Lean 13430 меток (67.1%). После отдельного контроля ремонта принято 11792 меток. Эти два счётчика различаются: окончание воспроизведения ещё не означает прохождение контроля качества.

| Модель | Ответов | Записано меток | Принято после ремонта | Осталось первичного воспроизведения |
|---|---:|---:|---:|---:|
| deepseek | 6672 | 4481 | 4192 | 2191 |
| goedel | 6672 | 4710 | 3408 | 1962 |
| kimina | 6672 | 4239 | 4192 | 2433 |
...
- Остаток первичного Lean: сценарий 0.9–1.8 ч при указанной загрузке, без новых блокирующих ошибок.
- GPU по сохранённым текстам: линейный ориентир 2.3 ч при двух устройствах; инженерный диапазон 2.3–4.5 ч.
- Последовательная сумма до первых практических сравнений: 3.2–6.4 ч. Разные модели могут перекрываться по этапам. Очередь и ремонт новых ошибок добавят время.
