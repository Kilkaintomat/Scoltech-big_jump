...
status=subprocess.check_output(["squeue","-u","denis.rakhmankin","-r","-o","%i|%j|%T|%R"],text=True)
...
sources=[ROOT/"metrics.json",ROOT/"manifest.json",ROOT/"review-enrichment.json",ROOT/"enrichment-manifest.json",
 HERE/"plan.json",HERE/"audit.py",HERE/"enrich.py",HERE/"render.py",HERE/"review-notes.json",HERE/"audit.sbatch",HERE/"enrich.sbatch",HERE/"render.sbatch",
