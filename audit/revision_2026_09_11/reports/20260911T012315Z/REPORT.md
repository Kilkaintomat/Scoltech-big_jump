...
Срез UTC: 2026-09-11T01:23:15.102873+00:00.
...
|---|---:|---:|---:|---:|---:|---|
| deepseek | 80 | 37 | ожидание | 0 | ожидание | не пройден |
| goedel | 80 | 35 | ожидание | ожидание | ожидание | не пройден |
| kimina | 80 | 0 | ожидание | ожидание | ожидание | не пройден |
...
Категории по температуре: `{"0.6": {"generation_truncation": 4, "parse_error": 1, "sorry_invalid_proof": 35}, "1.0": {"generation_truncation": 3, "sorry_invalid_proof": 37}}`.

Первичная ячейка ещё недоступна.

### goedel

Категории по температуре: `{}`.
...
- Серия: `/beegfs/home/denis.rakhmankin/onebigjump/runs/lean_recovery_20260911`.
- Snapshot: `/beegfs/home/denis.rakhmankin/onebigjump/audit/revision_2026_09_11/snapshots/recovery-20260911T011322Z`.
- Очередь: `/beegfs/home/denis.rakhmankin/onebigjump/runs/lean_recovery_20260911/queue.json`.
